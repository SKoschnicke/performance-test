...
--
-- * Creates the route datatype TestRoute. Every valid URL in your
--   application can be represented as a value of this type.
-- * Creates the associated type:
--       type instance Route Test = TestRoute
-- * Creates the value resourcesTest which contains information on the
--   resources declared below. This is used in Controller.hs by the call to
--   mkYesodDispatch
--
-- What this function does *not* do is create a YesodSite instance for
-- Test. Creating that instance requires all of the handler functions
...
instance YesodPersist Test where
    type YesodDB Test = SqlPersist
    runDB db = liftIOHandler
             $ fmap connPool getYesod >>= Settings.runConnectionPool db

instance YesodAuth Test where
    type AuthId Test = UserId
...
instance YesodAuthEmail Test where
    type AuthEmailId Test = EmailId
